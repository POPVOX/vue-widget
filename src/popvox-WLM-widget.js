(function () {
    ...
    function main() {
        ...
        jQuery(document).ready(function ($) {
            ...
            if (typeof $thisScript.data('route') == 'undefined')
            {
                // this is a pro widget
                var $widgetId = $thisScript.data('widget');
            }
            else
            {
                // this is a free widget
                var $widgetRoute = $thisScript.data('route');
            }
            ...
            var widgetUrl = typeof $thisScript.data('route') == 'undefined' ?
                $baseUrl + '/widgets/write-lawmaker?widget_id=' + $widgetId + '&referer=' + $ref :
                $baseUrl + '/widgets/write-lawmaker?widget_id=free&route=' + $widgetRoute + '&referer=' + $ref;
            ...
            jQuery.getJSON(jsonp_url, function(result) {
                ...
                ifrm.setAttribute('src', widgetUrl + '&ip_address=' + result.ip);
